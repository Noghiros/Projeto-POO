...
public class CadRemedio extends javax.swing.JFrame {
    ...
    public void excluir(){
        remedio = new Medicamento();
            ...
            remedio = (Medicamento) gerpro.consProCod(remedio);
    ...
    public void alterar(){
        remedio = new Medicamento();
            ...
            remedio = (Medicamento) gerpro.atualizaProCod(remedio);
    ...
    modelo.setRowCount(poslin);
        ...
        for(Produto rem : gerpro.getBdRem()){
    ...
    remedio = new Medicamento();
    try{
    remedio = (Medicamento) gerpro.cadPro(remedio);
