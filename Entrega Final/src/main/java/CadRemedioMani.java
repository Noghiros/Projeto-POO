...
public class CadRemedioMani extends javax.swing.JFrame {
    ...
    private GerMani germani = new GerMani();
    ...
    private void initComponents() {
        ...
        TblMed.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo de Barra", "Nome", "CPF", "Validade", "Preço"
            }
        ));
    ...
    try{
       remmani.setCodigoBarra(Integer.parseInt(cxcodigo.getText())); 
        ...
        DadoInvalidoException die = new DadoInvalidoException();
        remmani = die.correcaoRemmaniCodigoBarra(remmani);
    }
    try{
       remmani.setMiligramas(Integer.parseInt(cxpeso.getText())); 
    } catch(NumberFormatException nfe){
        DadoInvalidoException die = new DadoInvalidoException();
        remmani = die.correcaoRemmaniMg(remmani);
    }
    try{
       remmani.setPreco(Integer.parseInt(cxpreco.getText())); 
    } catch(NumberFormatException nfe){
        DadoInvalidoException die = new DadoInvalidoException();
        remmani = die.correcaoRemmaniPreco(remmani);
    }
    ...
    remmani = (Medmanipulado) germani.cadPro(remmani);
    ...
    public void desconto(){
     ...
     try{
        ...
        remmani = (Medmanipulado) germani.consProCod(remmani);
        
        if(remmani != null){
            cxpreco.setText(Integer.toString((int) remmani.getPreco()));
            
            JOptionPane.showMessageDialog(null,"Preço com Desconto: " +remmani.desconto(),"Desconto",1);
            limpar();
        }else{
    ...
    public void excluir(){
        remmani = new Medmanipulado();
            ...
            if(remmani != null){
                ...
                cxcpf.setText(Integer.toString(remmani.getCPF()));
    ...
    public void alterar(){
        remmani = new Medmanipulado();
            ...
            remmani = (Medmanipulado) germani.atualizaProCod(remmani);
    ...
    modelo.setRowCount(poslin);
        ...
        for(Produto rem : germani.getBdRem()){
